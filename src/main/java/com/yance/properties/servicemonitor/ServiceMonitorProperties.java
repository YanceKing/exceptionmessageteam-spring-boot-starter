package com.yance.properties.servicemonitor;
...
public class ServiceMonitorProperties implements InitializingBean {
	...
	public Duration getServiceNoticeInitialDelay() {
		return ServiceNoticeInitialDelay;
	}

	public void setServiceNoticeInitialDelay(Duration serviceNoticeInitialDelay) {
		ServiceNoticeInitialDelay = serviceNoticeInitialDelay;
	}
