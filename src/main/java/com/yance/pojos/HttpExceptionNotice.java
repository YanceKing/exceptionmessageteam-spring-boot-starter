...
public class HttpExceptionNotice extends ExceptionNotice {
	...
	public HttpExceptionNotice(Throwable exception, String filter, String url, Map<String, String> param,
	...
	protected String calUid() {
		String uid = super.calUid();
		return DigestUtils.md5Hex(String.format("%s:%s", this.url, uid));
	}
